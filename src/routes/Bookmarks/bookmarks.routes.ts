...
// import type { Bookmark, BookmarkWithTags } from "@/lib/types";
...
import { insertBookmarkSchema, selectBookmarksSchema } from "@/db/schema";
...
export const create = createRoute({
  ...
  tags,
  request: {
    body: jsonContentRequired(insertBookmarkSchema, "New bookmark data"),
  },
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
    ...
    [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(
      createErrorSchema(insertBookmarkSchema),
